...
def analyse_feature(plt_, df_, feature_name, feature_type, num_gr=10):
    print()
...
def plot_observations_by(by=None, df_=None, feature_name=None, fig=None, ax=None):
    ...
    if feature_name:
        ...
        # ONLY FOR NUMERIC FEATURES
            ...
            observations_by_months_and_year = pd.crosstab(index=df_['month'], columns=df_['year'],
                                                          values=df_[feature_name],
